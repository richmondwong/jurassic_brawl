...
player4AnimatedHealthBar: function(){
 ...
 // Added P3 and P4
      ...
      restartTextClick: function(){
       ...
       newGameText.events.onInputDown.add(function() { window.location.href = "http://localhost:3000/newgame";}, this);
      },
